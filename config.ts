export const BOT = {
	TOKEN: '6031f41b3b4ef9c8f78512b3b33fd643df18fa66b1a35d35fdf46dcaaee994cd', // Bot token here
	CLIENT_ID: '1340766854427181056', // Client ID here
	NAME: 'cgrif-Sage'// Bot Name. NEEDS TO BE LESS THAN 11 CHARACTERS
};

export const MONGO = '';

export const DB = {
	CONNECTION: 'mongodb+srv://cgriffith:ManchesterUnited25@cluster0.3ps8b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', // Mongo connection string here
	USERS: 'users',
	PVQ: 'pvQuestions',
	QTAGS: 'questionTags',
...
export const MAINTAINERS = 'Connor Griffith';// The current maintainers of this bot
